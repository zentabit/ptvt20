...
public class TurtleRace {
	...
	public static void main(String[] args) {
		...
		// dessutom är ju inte steglängden reguljär och vi kan inte kontrollera precis när paddan passerar mållinjen
		
		// lösning: paddorna beräknas parallellt i olika trådar
		// vi kollar på nåt sätt precis i det läge paddan passerar mållinjen.
	}
